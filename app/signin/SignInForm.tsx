  ...
  return (
    <div className="w-full max-w-sm">
      <div className="border border-border bg-surface/60 backdrop-blur-sm rounded p-6">
        <div className="font-mono text-[12px] tracking-[0.3em] text-muted mb-1">
          RESTRICTED ACCESS
        </div>
        ...
        {error && (
          <div className="mb-5 border border-accent-red/40 bg-accent-red/10 px-3 py-2 font-mono text-[13px] text-accent-red">
            {AUTH_ERRORS[error] || 'Sign-in failed. Try again.'}
          </div>
        )}

        {noProviders && (
          <div className="mb-5 border border-accent-gold/40 bg-accent-gold/10 px-3 py-2 font-mono text-[13px] text-accent-gold">
        ...
        {providers.email && providers.google && (
          <div className="flex items-center gap-3 my-5">
            ...
            <span className="font-mono text-[12px] tracking-[0.2em] text-muted">OR</span>
            <div className="h-px flex-1 bg-border" />
          </div>
        )}
